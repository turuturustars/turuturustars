                      ...
                      <CardContent className="p-4 space-y-3">
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0">
                            <p className="font-semibold truncate">{contribution.member?.full_name || 'Unknown'}</p>
                ...
                {welfareCases.length === 0 ? (
                  ...
                  welfareCases.map((welfareCase) => {
                    const progress = welfareCase.target_amount
                      ...
                      : 0;
                    return (
                      <Card key={welfareCase.id} className="border border-border/60">
                        <CardContent className="p-4 space-y-3">
                          <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                              <p className="font-semibold truncate">{welfareCase.title}</p>
                              <p className="text-xs text-muted-foreground capitalize">{welfareCase.case_type}</p>
                            </div>
                            <Badge
                              className={
                          ...
                          <div className="grid grid-cols-2 gap-3 text-xs">
                            <div>
                              ...
                              <p>KSh {(welfareCase.target_amount || 0).toLocaleString()}</p>
                            </div>
                            <div>
                              <p className="text-muted-foreground">Collected</p>
                              <p className="font-semibold text-green-700">KSh {(welfareCase.collected_amount || 0).toLocaleString()}</p>
                            </div>
                          </div>

...
export const PAGE_METADATA: Record<string, PageMetaData> = {
  ...
  HOME: {
    ...
    description:
      'Turuturu Stars Community Based Organization serving Turuturu, Muranga County. Manage contributions, welfare assistance, and community events. Join our united family in Turuturu, Githima, Kigumo, and surrounding areas.',
    keywords: [
      'Turuturu Stars',
      'CBO Kenya',
